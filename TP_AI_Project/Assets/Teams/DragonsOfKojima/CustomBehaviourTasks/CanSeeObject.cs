...
namespace DragonsOfKojima
{
    ...
    {
        [UnityEngine.Tooltip("The object that we are searching for")]
        ...
        {
            RaycastHit hit;
            Debug.DrawLine(transform.position, targetObject.transform.position, Color.green);
        ...
        public override void OnDrawGizmos()
        {
            ...
            var beginDirection = Quaternion.AngleAxis(-halfFOV, Vector3.forward) * Owner.transform.right;
            UnityEditor.Handles.DrawSolidArc(Owner.transform.position, Owner.transform.forward, beginDirection, fieldOfViewAngle.Value, viewDistance.Value);
